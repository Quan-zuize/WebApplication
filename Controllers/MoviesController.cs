...
namespace WebApplication2.Controllers
{
    ...
    {
        private ExamEntities2 db = new ExamEntities2();

        // GET: Movies
        public ActionResult Index(string search)
        {
            var searches = search.Trim();
            return View(db.Movies.Where(X => X.Title == searches || X.Genre.GenreName == searches || searches == "").ToList());
        }
